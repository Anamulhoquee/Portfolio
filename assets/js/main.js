!(function ($) {
    ...
    $(document).ready(function() {
        ...
        $('#dark-mode-toggle i').removeClass('bx-moon').addClass('bx-sun');
        $('#dark-mode-toggle span').text('Light Mode');
        localStorage.setItem('theme', 'dark');

        // Check for saved user preference (overrides default if light mode was previously selected)
        const currentTheme = localStorage.getItem('theme');
        if (currentTheme === 'light') {
            $('body').attr('data-theme', 'light');
            $('#dark-mode-toggle i').removeClass('bx-sun').addClass('bx-moon');
            $('#dark-mode-toggle span').text('Dark Mode');
        }
